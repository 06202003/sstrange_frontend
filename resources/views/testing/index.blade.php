                                        ...
                                        <div class=" modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="settingsModalLabel">Manual Prompt for Generative AI</h5>
                                                ...
                                                <div class="modal-body ">
                                                    <form id="manual-prompt-form">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea id="manualPrompt" class="form-control fontsizeall" rows="5" placeholder="Type your manual prompt here..."></textarea>
                                                        </div>
                                                </div>
            ...
            $('#parsed-form').on('submit', function(e) {
                ...
                questionBlocks.forEach(function(questionBlock, index) {
                    ...
                    $.ajax({
                        ...
                        // url: "https://506b-2001-448a-3032-e388-b507-f6ef-16-2004.ngrok-free.app/generate-code",
